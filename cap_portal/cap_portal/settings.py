...
# If a user goes to login/ directly, I'll redirect to the users:index page (no next parameter in URL)
...
# Test users
TEST_USER_IDS = [4,7,8,9,11,12]
EXCLUDE_TEST_USERS_BY_DEFAULT=True